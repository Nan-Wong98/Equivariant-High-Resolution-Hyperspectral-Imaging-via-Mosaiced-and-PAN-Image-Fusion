...
### pansharpening
```
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_994.pth --lr_decay --save_freq 5 --device 5
```

## 🔵 ICVL
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 10 --device 1
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 40 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_51.pth --lr_decay --save_freq 5 --device 2
```
...
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_994.pth --load_ps_model ./2/model/best_46.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_994.pth --load_ps_model ./2/model/best_46.pth --data_id oil_painting_ms.mat
```

## 🔵 ICVL
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_51.pth --load_ps_model ./4/model/best_7.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_51.pth --load_ps_model ./4/model/best_7.pth --data_id nachal_0823-1127.mat
```
...
### generate single
```
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_demosaic_model ./5/model/best_17.pth --load_ps_model ./6/model/best_6.pth --data_id 1.raw 16.raw 37.raw
```
