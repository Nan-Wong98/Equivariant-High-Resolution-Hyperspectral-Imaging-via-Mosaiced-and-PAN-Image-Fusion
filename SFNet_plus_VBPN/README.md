...
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_2760.pth --load_ps_model ./2/model/best_25.pth

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_2760.pth --load_ps_model ./2/model/best_25.pth --data_id oil_painting_ms.mat
```

## ICVL
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_199.pth --load_ps_model ./4/model/best_39.pth

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_199.pth --load_ps_model ./4/model/best_39.pth --data_id nachal_0823-1127.mat
```
