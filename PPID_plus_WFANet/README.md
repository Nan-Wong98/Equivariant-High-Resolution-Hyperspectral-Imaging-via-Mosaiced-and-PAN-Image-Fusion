...
Only the pansharpening network (**WFANet**) is trained in this framework.
...
### pansharpening
```
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 10 --device 4
```

## 🔵 ICVL
### pansharpening
```
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 64 --batch_size 16 --lr_decay --save_freq 1 --device 6
```
...
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_ps_model ./2/model/best_15.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_ps_model ./2/model/best_15.pth --data_id oil_painting_ms.mat
```

## 🔵 ICVL
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_ps_model ./4/model/best_3.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_ps_model ./4/model/best_3.pth --data_id nachal_0823-1127.mat
```
...
### generate single
```
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_ps_model ./6/model/best_40.pth --data_id 1.raw 16.raw 37.raw
```
