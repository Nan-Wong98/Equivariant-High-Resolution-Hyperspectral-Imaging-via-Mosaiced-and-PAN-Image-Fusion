...
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset CAVE --epochs 10000 --train_size 64 --stride 32 --batch_size 1 --lr_decay --save_freq 50 --device 3
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_2760.pth --lr_decay --save_freq 5 --device 1
```

## 🔵 ICVL
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 400 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --device 3
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 40 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_199.pth --lr_decay --save_freq 5 --device 6
```
...
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_2760.pth --load_ps_model ./2/model/best_16.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_2760.pth --load_ps_model ./2/model/best_16.pth --data_id oil_painting_ms.mat
```

## 🔵 ICVL
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_199.pth --load_ps_model ./4/model/best_3.pth
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_199.pth --load_ps_model ./4/model/best_3.pth --data_id nachal_0823-1127.mat
```
...
### generate single
```
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_demosaic_model ./5/model/best_499.pth --load_ps_model ./6/model/best_11.pth --data_id 1.raw 16.raw 37.raw
```
