...
``` 
# demosaic
python train_demosaic_simulate.py --idx 1 --data_path ../../DataSet --dataset CAVE --epochs 10000 --train_size 64 --stride 32 --batch_size 1 --lr_decay --save_freq 50 --device 4

# pansharpening
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 1000 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_9757.pth --lr_decay --save_freq 50 --device 3
```

## ICVL
```
# demosaic
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --device 2

# pansharpening
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 40 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_130.pth --lr_decay --save_freq 5 --device 4
```
...
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_9757.pth --load_ps_model ./2/model/best_955.pth

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_9757.pth --load_ps_model ./2/model/best_955.pth --data_id oil_painting_ms.mat
```

## ICVL
```
# all
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_130.pth --load_ps_model ./4/model/best_37.pth

# assign
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_130.pth --load_ps_model ./4/model/best_37.pth --data_id nachal_0823-1127.mat
```
